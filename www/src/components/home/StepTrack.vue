    ...
    <div class="row">
      ...
      <div class="instrument-select col-2 pt-4">
        <div class="d-flex justify-content-around" v-if="isNoteTrack">
          <select class="note" v-model="note" @change="noteChange">
          ...
          <select class="octave" v-model="octave" @change="noteChange">
  ...
  export default {
    ...
    data() {
      return {
        ...
        muted: false,
        solo: false,
        note: this.stepTrack.instrumentName.charAt(0),
        octave: this.stepTrack.instrumentName.charAt(1)
      }
    },
    computed: {
      isNoteTrack() {
